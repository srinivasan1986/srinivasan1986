...
export default function HeaderTextValidateLength(context) {
    
    const noteValue = context.getValue();
    let charLimit = Number(context.getGlobalDefinition('/SAPAssetManager/Globals/Inventory/HeaderTextFieldLength.global').getValue());
