...
export default function GetMaterialDocItemsListQuery(clientAPI) {
    ...
    return clientAPI.read('/SAPAssetManager/Services/AssetManager.service', 'MaterialDocItems', ['MaterialDocNumber'], matDocItemsQueryOptions).then((result) => {
        ...
        if (result && result.length > 0) {
            ...
            qb.expand('AssociatedMaterialDoc', 'Reservation_Nav', 'ReservationItem_Nav', 'PurchaseOrder_Nav', 'PurchaseOrderItem_Nav', 'STO_Nav', 'StockTransportOrderItem_Nav', 'SerialNum');
            ...
            qb.orderBy('AssociatedMaterialDoc/PostingDate desc, MaterialDocNumber desc, MatDocItem');
