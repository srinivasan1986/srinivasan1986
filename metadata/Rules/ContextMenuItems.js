...
export function getOperationMenuItems() {
    return [
        ...
        },
        {
            ...
            'Text': '$(L,complete)',
            'Mode': 'Normal',
            'OnSwipe': '/SAPAssetManager/Rules/Operations/MobileStatus/OperationCompleteStatus.js',
        },
        {
...
export function getSubOperationMenuItems() {
    return [
        ...
        },
        {
            ...
            'Text': '$(L,complete)',
            'Mode': 'Normal',
            'OnSwipe': '/SAPAssetManager/Rules/SubOperations/MobileStatus/SubOperationCompleteStatus.js',
        },
        {
