...
export default function ReferenceValidateLength(context) {
    
    const noteValue = context.getValue();
    let charLimit = Number(context.getGlobalDefinition('/SAPAssetManager/Globals/Inventory/ReferenceFieldLength.global').getValue());
