...
export class BaseExtensionParser {
    ...
    public bind(fromValue: any, context: Context, bTwoWay: boolean, key: string): Promise<any> {
    ...
    public parseValue(value: any, context: Context): any {
     ...
     */
    public getValueFromMultipleBinding(value: string, context: Context) {
        let regex = /{(.+?)}/g;
        let match;
        let results = [];
     ...
     */
    public localizeValue(context: Context, mValue: string) {
